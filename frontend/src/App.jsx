...
const statusBadge = {
  ...
  match_suggested: "bg-indigo-100 text-indigo-700",
  claim_pending: "bg-blue-100 text-blue-700",
  className="w-full rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm text-slate-700 placeholder:text-slate-400 focus:border-teal-600"
...
function App() {
  ...
  className = "search-input focus:border-teal-600"
  ...
  className = "rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm text-slate-700 focus:border-teal-600"
  ...
  useEffect(() => {
    ...
    if (!isAuthenticated) {
      return (
        <div className="min-h-screen bg-gradient-to-br from-teal-50 via-white to-slate-50 px-4 py-8">
          <div className="mx-auto max-w-md">
            <header className="rounded-3xl border border-white/80 bg-white/90 p-6 shadow-glow backdrop-blur-sm">
              <p className="text-xs font-bold uppercase tracking-[0.35em] text-teal-700">LostLink</p>
                  ...
                  <div className="grid gap-4 md:grid-cols-2">
                    {items.map((item) => (
                      <div
                        ...
                        className={`cursor-pointer rounded-3xl border p-3 transition duration-200 hover:-translate-y-1 hover:shadow-soft ${selectedItem?.id === item.id ? "border-teal-300 bg-teal-50" : "border-slate-200 bg-slate-50 hover:border-slate-300"}`}
                      >
                    ...
                    <div className="mt-4 space-y-4 rounded-3xl border border-slate-200 bg-slate-50 p-4">
                      ...
                      <form onSubmit={handleClaimSubmit} className="space-y-3">
                        <input
                          ...
                          className="w-full rounded-2xl border border-slate-200 bg-white px-4 py-3 text-sm text-slate-700 placeholder:text-slate-400 focus:border-teal-600"
                      ...
                      {matches.map((match) => (
                        <div key={match.id} className="rounded-2xl border border-slate-200 bg-slate-50 p-3">
                          <div className="flex items-start justify-between gap-3">
                            ...
                            <span className="rounded-full bg-indigo-100 px-2.5 py-1 text-[10px] font-semibold uppercase tracking-[0.2em] text-indigo-700">
                              {match.score}%
                            </span>
                          </div>
              ...
              <form onSubmit={handleItemSubmit} className="mt-5 space-y-4">
                ...
                <div className="grid gap-4 md:grid-cols-2">
                  <input
                    ...
                    className="rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm text-slate-700 placeholder:text-slate-400 focus:border-teal-600"
                ...
                <div className="rounded-2xl border border-dashed border-slate-300 bg-slate-50 p-4">
                  <label className="flex cursor-pointer flex-col items-center justify-center rounded-2xl border border-dashed border-slate-300 bg-white px-4 py-5 text-center text-sm text-slate-600 transition hover:border-teal-300 hover:text-slate-900">
